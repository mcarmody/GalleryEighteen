...
document.addEventListener('DOMContentLoaded', function(){
    ...
    var mapID = "map";
    var mapBoxID = "madcarmody.hd0dcpom";
    var startingLatLong = [42.888569, -87.635528];
    var startingZoom = 11;
    var defaultMarkerColor = '#555';
        ...
        if (request.status >= 200 && request.status < 400){
            ...
            geoJSON = _.map(marketData, function(element, index) {
                ...
                return {
                    ...
                    day: element.day,
                    duration: element.start_time + ' - ' + element.end_time,
                    geometry: {
                        type: 'Point',
            ...
            map.featureLayer.eachLayer(function(layer) {
                var templateCode = document.getElementById('tooltip').innerHTML;
                var compiledTemplate = _.template(templateCode);

                var content = compiledTemplate({
                    intersection: layer.feature.name,
                    day: layer.feature.day + 's, from ' + layer.feature.duration
                });
